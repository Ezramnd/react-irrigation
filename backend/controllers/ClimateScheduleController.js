...
const createClimateManualTopicFromMac = (macAddress) => {
    ...
    return `hafizh11/esp32/alat/${topicMac}/climate-manual/set`; 
}
...
const createClimateTopicFromMac = (macAddress) => {
    ...
    return `hafizh11/esp32/alat/${topicMac}/climate-jadwal/set`; 
}
...
const createClimateSettingsTopicFromMac = (macAddress) => {
    ...
    return `hafizh11/esp32/alat/${topicMac}/climate-settings/set`; 
}
...
const createClimateModeTopicFromMac = (macAddress) => {
    ...
    return `hafizh11/esp32/alat/${topicMac}/climate-mode/set`; 
}
